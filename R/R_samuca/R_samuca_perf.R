  ...
  for(s in f.seq){
    ...
    if(fl.plan.soil){
      ...
      if(any(obs.data.plan$M_ID %in% m.id)){
        ...
        perf.plan.seq.df =  perf.plan.seq(obs.f,
                                          sim.ctl,
                                          sim.obs.idx,
                                          plan.sim,
                                          f,
...
if(save.sim.obs){
  ...
  write.csv(perf.dt.plan, file = paste0(wd.core,"\\results_perf\\","Perf_Data_Plan_",analysis.id,".csv"), row.names = F)
  write.csv(perf.dt.soil, file = paste0(wd.core,"\\results_perf\\","Perf_Data_Soil_",analysis.id,".csv"), row.names = F)
  write.csv(perf.dt.temp, file = paste0(wd.core,"\\results_perf\\","Perf_Data_Temp_",analysis.id,".csv"), row.names = F)
  write.csv(perf.dt.atmo, file = paste0(wd.core,"\\results_perf\\","Perf_Data_Atmo_",analysis.id,".csv"), row.names = F)
}
...
write.csv(perf.var.plan.results, file = paste0(wd.core,"\\results_perf\\","Perf_Plan_",analysis.id,".csv"), row.names = F)
write.csv(perf.var.soil.results, file = paste0(wd.core,"\\results_perf\\","Perf_Soil_",analysis.id,".csv"), row.names = F)
write.csv(perf.var.temp.results, file = paste0(wd.core,"\\results_perf\\","Perf_Temp_",analysis.id,".csv"), row.names = F)
write.csv(perf.var.atmo.results, file = paste0(wd.core,"\\results_perf\\","Perf_Atmo_",analysis.id,".csv"), row.names = F)
