        ...
        MODULE OUTAUN__genmod
          INTERFACE 
            SUBROUTINE OUTAUN(TASK,AUN,OUTFIL,PATHWORK,NUMNOD,OUTPER,   &
     &PERIOD,POND,GWL,THETA,H,INQ,INQROT,NRLEVS,INQDRA,IEVAP,IPEVA,IPTRA&
     &,IRUNO,NUMLAY,BOTCOM,DZ,THETAS,COFGEN,SWAUN,IGRAI,IGIRD,INRAI,    &
     &INIRD,IINTC,GC,LAI,TAV,TSOIL,DAYCUM,RD,CF,WBALANCE,PROJECT,TSTART,&
     &TEND,SWDISCRVERT,NUMNODNEW,DZNEW,SWAFO,SWMACRO,SSNOW,IGSNOW,ISNRAI&
     &,ISUBL,IRUNON,FRARMTRX,IPONDBEG,ISSNOWBEG,ITHETABEG,VLMPSTDM1,    &
     &VLMPSTDM2,DIPOCP,WALEVDM1,VLMPDM1,WASRDM1,VLMPDM2,WASRDM2,        &
     &IQINTOPPREDM1,IQINTOPLATDM1,INQEXCMTXDM1CP,INQOUTDRRAPCP,         &
     &IAVFRMPWLWTDM1,IQINTOPPREDM2,IQINTOPLATDM2,INQEXCMTXDM2CP,        &
     &IAVFRMPWLWTDM2,IWASRDM1BEG,IWASRDM2BEG,CRITDEVMASBAL,TCUM,NOD1LAY,&
     &SWSOPHY,NUMTAB,SPTAB)
            ...
            END SUBROUTINE OUTAUN
          END INTERFACE 
        END MODULE OUTAUN__genmod
